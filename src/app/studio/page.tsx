    ...
    <div className="container">
      ...
      <section style={{ padding: "100px 0", borderTop: "1px solid var(--accent)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: "40px", marginBottom: "100px" }}>
          ...
          <div style={{ gridColumn: "7 / span 6" }}>
            <div style={{ marginBottom: "12px" }}>
              <h3 style={{ fontSize: "24px", fontWeight: 900, marginBottom: "6px" }}>AI Intern – ChatMaven.ai</h3>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: "40px", marginBottom: "100px" }}>
          ...
          <div style={{ gridColumn: "7 / span 6" }}>
            <h3 style={{ fontSize: "24px", fontWeight: 900, marginBottom: "6px" }}>Vishwakarma University, Pune</h3>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: "40px", marginBottom: "100px" }}>
          ...
          <div style={{ gridColumn: "7 / span 6" }}>
            {[
              { label: "Languages", value: "Python, C++, JavaScript, SQL" },
              { label: "AI / ML", value: "PyTorch, Hugging Face, RAG (FAISS, Sentence Transformers), Reinforcement Learning" },
              { label: "Systems & Cloud", value: "FastAPI, AWS Lambda, SES, SNS, API Gateway, Docker" },
              { label: "Agentic & Tools", value: "LangGraph, Git/GitHub, Cursor, GitHub Copilot" },
              { label: "Product", value: "MVP scoping · Requirements translation · AI quality evaluation · Cross-functional collaboration · Data-informed iteration" },
            ].map(({ label, value }) => (
